...
<body class="min-h-screen text-dc-text antialiased">
    <div class="mx-auto flex min-h-screen max-w-md flex-col px-6 py-6 pb-28 lg:pb-6">
        <div class="flex items-center justify-between">
            <div class="flex items-center gap-3">
                <a href="{{ $back ?? route('home') }}" class="flex h-8 w-8 shrink-0 items-center justify-center rounded-full text-dc-text hover:bg-white/60" aria-label="Back">
